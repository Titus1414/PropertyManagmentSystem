...
{
    public partial class PurchaseWin : Form
    {
        public PurchaseWin()
        {
            InitializeComponent();
        ...
        private void DataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            AddNewAssetsOrDetailUpdate addNewAssetsOrDetailUpdate = new AddNewAssetsOrDetailUpdate(SubHead: SbHead, Name: Name, brand: Brand, Color: Color, Qty: Quantity, dt: Date, totalPrice: ttPrice, unitPrice: UtPrice, VendorName: VendName, img);
            addNewAssetsOrDetailUpdate.Show();
        }

        private void PurchaseWin_Load(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(variables.cons);
            string query = "select ID,ExpensHeadName as [Asset Name],Name,Brand,Color,Quantity,Date,TotalPrice,UnitPrice,VendorName,Image from AssetDetail";
            con.Open();
