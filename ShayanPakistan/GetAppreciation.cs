...
{
    public partial class GetAppreciation : Form
    {
        SqlConnection con = new SqlConnection(variables.cons);

        public GetAppreciation()
        {
            InitializeComponent();
            this.TopMost = true;
            LoadData();
        ...
        void LoadData()
        {
            ...
            string query = "select e.Appriciation, e.Date,Reason,Detail from ExtraPaidOrFine e where Month(e.Date) = '" + sdf123 + "' and Eid = " + id + " ";
        ...
        private void GetAppreciation_Load(object sender, EventArgs e)
        {
